...
//		wordList.add("log");
//		wordList.add("cog");
//		System.out.println(new Test().ladderLength4(beginWord, endWord, wordList));
		String beginWord = "qa";
		String endWord = "sq";
		String[] wordList = new String[]{"si","go","se","cm","so","ph","mt","db","mb","sb","kr","ln","tm","le","av","sm","ar","ci","ca","br","sq","ye"};
		System.out.println(new Test().ladderLength(beginWord, endWord, new ArrayList<String>(Arrays.asList(wordList))));
